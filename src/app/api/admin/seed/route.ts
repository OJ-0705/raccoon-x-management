...
感情を出す場面（タメ口100%）：
- 「これマジでヤバい」「神すぎる」「優勝した」「絶望した」
- 「なんでこんなに脂質高いんだよ…」「旨すぎて泣いた」

知識を語る場面（タメ口＋軽い丁寧語ミックス）：
- 「脂質は1gで9kcalらしい。タンパク質の倍以上ある」
- 「実は洋なし型って日本人の57%が該当するって言われてる」
- ※「〜です」「〜ます」は使わない。「〜らしい」「〜って言われてる」「〜なんだって」を使う
...
- 「脂質制限って最初は地獄だと思ってたけど、慣れると意外と楽しい」
- 「裏面チェックが趣味になってきた」
