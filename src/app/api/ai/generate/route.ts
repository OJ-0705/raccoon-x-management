...
パーソナル投稿のOK例：
○ 「遺伝子検査で洋なし型と出た時、正直ピンとこなかった。でも調べていくうちに『だから揚げ物食べると太りやすかったのか』と全部繋がった。自分の体質を知った瞬間って不思議なもので、その日からコンビニでの行動が変わった」
○ 「昨日の飲み会がキツかった。周りはフライドポテトとチーズの盛り合わせ。俺はハイボールとあたりめ。『それだけ？』って言われたけど、洋なし型の俺にとってはこれが戦い方なんだよ」
○ 「正直に言う。正月に実家帰って3日で3キロ太った。おせちが旨すぎるのが悪い。でもこれ、昔の俺なら『明日から断食だ！』ってなってた。今は違う。脂質だけ意識して1週間で戻す」

パーソナル投稿のNG例（これは情報投稿であってパーソナルではない）：
× 「おせんべいの脂質は0.5〜2.0gです」
× 「コンビニで買える低脂質食品を紹介します」
...
- フックの後は改行を入れて「続き」感を演出
- 本文は体験談・具体的数値・感情を交えてしっかり語る
- 短すぎる投稿は情報bot感が出るのでNG
- 最後は読者への問いかけや呼びかけで締める

ハッシュタグ: 原則つけない（つけても最大1個）
理由: 2025年以降、Xのアルゴリズムはハッシュタグをほぼ無視。
イーロン・マスクが「不要」と発言済み。3個以上はスパム扱いリスクあり。
代わりに「脂質制限」「低脂質」「洋なし型」などのキーワードを
自然な文章の中に組み込むこと。

その他の鉄則:
1. 冒頭1文目の文末に「。」を入れない（フック効果）
2. 具体的な数字を入れる（脂質○g、○kcal、○円）
3. 絵文字を適切に使う（過剰NG、2〜4個程度）
...
【改行】
- 文章と文章の間には必ず改行を入れること
- 2〜3文ごとに空行を入れて読みやすくする
- 長い段落を塊にまとめない

【語尾】
- 「〜だよ」「〜だ」「〜なんだ」だけで終わる淡白な文末はNG
- カジュアルで親しみやすい語尾を使う
  例：「〜だよね」「〜じゃん」「〜だったりする」「〜かな」「〜かもしれない」「〜んだよな」「〜してみて」「〜てる」「〜じゃない？」
- 友達に話しかけるような温度感を意識する
...
sample_03: え？バターチキンカレーなのに成分良過ぎる‥脂質7.2g。低脂質。たんぱく質と食物繊維も摂れるのに税込399円。物価高騰の今めちゃくちゃ助かる‥
...
sample_06: 昨日の飲み会がキツかった。周りはフライドポテトとチーズの盛り合わせ。俺はハイボールとあたりめ。「それだけ？」って言われたけど、洋なし型の俺にとってはこれが戦い方なんだよ。帰り道に茎わかめ買って帰った。脂質ほぼ0gの救世主

[C群：パーソナル体験・感情型]
sample_07: 遺伝子検査で「洋なし型」と出た時、最初はピンとこなかった。でも調べていくうちに「だから揚げ物食べると太りやすかったのか」と全てが繋がった。体質を知る前と後で、食事への向き合い方が根本的に変わった。これが俺の転換点だった

sample_08: 正直に言う。正月に実家帰って3日で3キロ太った。おせちが旨すぎるのが悪い。でもこれ、昔の俺なら「明日から断食だ！」ってなってた。今は違う。脂質だけ意識して玄米食べて、1週間で戻す。遺伝子検査受けてから、無茶しなくなった自分がちょっと好き

sample_09: 無茶なダイエットで倒れた経験がある。カロリーを極限まで削って毎日走ってたら、仕事中に貧血でぶっ倒れた。「頑張れば痩せる」は方向が間違ってたら体を壊すだけだった。今は脂質だけに集中。倒れることがなくなったのは、正しい方向に努力できるようになったから

[D群：知識カジュアル型]
sample_10: 知ってた？脂質は1gで9kcal。タンパク質と糖質は4kcal。同じ量でもカロリーが倍以上違う。俺が糖質じゃなくて脂質に集中してコントロールしてる理由がこれ

sample_11: マヨネーズ大さじ1杯で脂質9gって知ってた。大さじ1杯て。サラダにかけた瞬間にサラダの意味が消える。ノンオイルドレッシングに切り替えた瞬間、世界が変わった

[E群：お酒・おつまみ型]
sample_12: 昨日の飲み会で枝豆と焼き鳥（塩）だけで乗り切った。周りはフライドポテトとチーズ盛り合わせ。俺は黙ってハイボールとあたりめ。これが洋なし型の戦い方

[F群：問いかけ・共感型]
sample_13: 脂質制限始めてから変わったこと。コンビニで商品を手に取る→必ず裏面を見る→脂質を確認→棚に戻す。この動作を1日10回はやってる。同じ人いる？

sample_14: ローファット vs ローカーボ、みんなはどっち派？俺は遺伝子的に脂質で太るタイプだからローファット一択。でも大事なのは「どっちが自分に合うか」だと思ってる
...
- 投稿文のみ出力（説明不要）`
    ...
    const message = await client.messages.create({
      ...
      max_tokens: formatType === '長文投稿' ? 4000 : 2000,
